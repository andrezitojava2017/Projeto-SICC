 ...
 * @author Andre
 */
public class Certidao_Nascimento extends javax.swing.JDialog {
    ...
    /**
     * Creates new form Certidao_Nascimento
     */
    public Certidao_Nascimento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
//        setOpacity(0.90f);
    }
...
//        checkPaiAusente.setEnabled(false);
    ...
    private void initComponents() {
        ...
        setTitle("Registro de Nascimento");
        setResizable(false);
        ...
        btnSalvarPai.setText("Confirmar");
        ...
        btnSalvarAlteracaoPai.setText("Salvar alteração");
        ...
        btnBuscarPai.setText("Localizar pessoa");
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(painelPai, javax.swing.GroupLayout.DEFAULT_SIZE, 1029, Short.MAX_VALUE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(painelPai, javax.swing.GroupLayout.PREFERRED_SIZE, 345, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        btnSalvarMae.setText("Confirmar");
        ...
        btnBuscarMae.setText("Buscar pessoa");
        ...
        btnSalvarAlteracaoMae.setText("Salvar alteração");
        ...
        btnSalvarRegistrando.setText("Confirmar");
        ...
        btnSalvarAlteracaoRegistrando.setText("Salvar alteração");
    ...
    private void checkPaiAusenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkPaiAusenteActionPerformed
        ...
        if (checkPaiAusente.isSelected()) {
            ...
            JOptionPane.showMessageDialog(this, "Esta opção deve ser marcada, quando o pai do registrando não está presente no ato", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnBuscarPaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarPaiActionPerformed
        ...
        Localizar_Pessoas_View buscar = new Localizar_Pessoas_View(null, true, 0);
    ...
    private void btnBuscarMaeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarMaeActionPerformed
        ...
        Localizar_Pessoas_View buscar = new Localizar_Pessoas_View(null, true, 2);
        buscar.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Certidao_Nascimento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Certidao_Nascimento dialog = new Certidao_Nascimento(new javax.swing.JFrame(), true);
